///OBA_ASTRONAUTICA1_008
draw_set_alpha(image_alpha);

draw_text_ext_colour(DW/2,DH/3,"A energia dos satélites é obtida por meio dos painéis solares, que transformam a luz do Sol em energia elétrica",20,DW*.8,16743936,16743936,16743936,16743936,image_alpha);
