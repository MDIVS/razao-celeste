...
draw_sprite(spr_pbs02,0,DW/2,160);
draw_set_colour(c_silver);
draw_text(DW/2,360,"Não é para iniciantes.#A definição de equilíbrio e maleabilidade.##Carcaça:#Massa: 225t");
draw_set_colour(-1);
...
if (Now[0] == 0) {
    ...
    if (Now[1] == 1) {
        ...
        GUI=scr_menu;
        ini_open("Salvo.ini");
        ini_write_real("Player","ObjectId",obj_pbs02);
        ini_close();
        draw_set_alpha(1);
        exit;
    }
