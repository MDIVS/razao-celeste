...
dra_planet(DW/2,DH/2,40,1,image_index,0,background_get_texture(tx_venus));
draw_text_ext_colour(DW/2,DH/3,'Vênus não tem luas',20,DW*.8,16743936,16743936,16743936,16743936,image_alpha);
