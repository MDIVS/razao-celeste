///OBA_ASTRONAUTICA1_002
draw_set_alpha(image_alpha);

draw_text_ext_colour(DW/2,(DH-280)/2,"Os satélites são úteis para monitorar o meio ambiente",20,DW*.8,16743936,16743936,16743936,16743936,image_alpha);
