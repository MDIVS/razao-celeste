...
draw_text_ext_colour(DW/2,DH/3,"Translação é o movimento que um planeta realiza quando gira em torno de si mesmo.",20,DW*.8,16743936,16743936,16743936,16743936,image_alpha);
