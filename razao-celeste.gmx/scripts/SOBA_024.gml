...
draw_text_ext_colour(DW/2,DH/3,"É possível observar crateras, montanhas e muitos buracos na superfície da Lua quando a observamos através de um binóculo ou, através de até mesmo uma simples luneta feita em casa com lente de óculos",20,DW*.8,16743936,16743936,16743936,16743936,image_alpha);
