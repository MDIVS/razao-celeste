...
draw_text(DW-32,DH-29,"(OBA, 2018, nv3: questão 1)");
var t = "www.oba.org.br";
draw_text_colour(DW-32,DH-16,t,c_orange,c_orange,c_orange,c_orange,image_index/30);
draw_text(DW-32-string_width(t),DH-16,"Disponível em ");
