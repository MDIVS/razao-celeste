...
draw_text_ext_colour(DW/2,DH/3,"O ano terrestre dura 365 dias porque esse é o período que o planeta leva para completar uma volta em torno do sol.",20,DW*.8,16743936,16743936,16743936,16743936,image_alpha);
