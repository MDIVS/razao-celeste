...
var t = "Júpiter é o maior planeta do Sistema Solar, tanto em diâmetro quanto em massa, e é o quinto mais próximo do Sol. Possui menos de um milésimo da massa solar, contudo tem 2,5 vezes a massa de todos os outros planetas em conjunto. É um planeta gasoso, junto com Saturno, Urano e Netuno.";
...
if (Botao_rect(DW*.6,DH*.8+16,DW*.8,DH*.8+48,16,"Próximo",4210432,c_white,1)) {
    with(PLANETA) instance_destroy();
    PLANETA = instance_create(0,0,obj_Saturno);;
