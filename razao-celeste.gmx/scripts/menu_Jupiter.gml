...
dra_planet(DW/2,DH/2,96*.7,1,image_index,25,background_get_texture(tx_jupiter));
...
if BTech(MA,image_index,96,DH/4*3,64,"Órbita",16743936){Now[1]=-3;Now[2]=jupiter_orbita;PlaySom(sound2,0,VSom,0)}

draw_set_valign(fa_top);
draw_text(DW/2,20,"Planeta Júpiter");
draw_text(DW/2,DH/2-128,"Missão - Defenda a Estação");
draw_set_font(arial8);
draw_text_ext(DW/2,48,'Júpiter é o maior planeta do Sistema Solar, tanto em diâmetro quanto em massa, e é o quinto mais próximo do Sol. Possui menos de um milésimo da massa solar, contudo tem 2,5 vezes a massa de todos os outros planetas em conjunto. É um planeta gasoso, junto com Saturno, Urano e Netuno',12,DW*.8);
...
#define jupiter_orbita
ini_open("Salvo.ini");
draw_set_alpha(Now[0]/30);
draw_text(DW/2,40,"Órbita do Planeta Júpiter");

var i,dir=360/365*Now[3],s=DW/3/816/2;
draw_primitive_begin(pr_linestrip);
for(i=0;i<=360;i+=2)draw_vertex(DW/2+lengthdir_x(816*s,i),DH/2+lengthdir_y(740*s,i));
draw_primitive_end();
...
var xx=DW/2+lengthdir_x(816*s,dir),yy=DH/2+lengthdir_y(740*s,dir);
...
draw_text(xx+20,yy,"Júpiter");
draw_set_halign(fa_right);
draw_text(xx-20,yy,"dia "+string(round((dir mod 360)/360*4331)));
draw_set_halign(fa_center);
Now[3]++;

dra_planet(96,DH/4*3,64*.7,1,image_index,25,background_get_texture(tx_jupiter));
if BTech(MA,image_index,96,DH/4*3,64,"Júpiter",16743936){Now[1]=-3;Now[2]=menu_Jupiter;PlaySom(sound2,0,VSom,0)}
if Bspr(MA,spr_home,0,DW/2,DH-48){Now[1]=-3;Now[2]=ini_gasososview;PlaySom(sound1,0,VSom,0)};
