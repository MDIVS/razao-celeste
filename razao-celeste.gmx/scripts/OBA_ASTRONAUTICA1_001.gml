///OBA_ASTRONAUTICA1_001
draw_set_alpha(image_alpha);

draw_text_ext_colour(DW/2,DH/3,"Os satélites servem para localizar os incêndios das florestas",20,DW*.8,16743936,16743936,16743936,16743936,image_alpha);
