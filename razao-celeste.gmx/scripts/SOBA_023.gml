...
draw_text_ext_colour(DW/2,DH/3,"Como você sabe, a Lua é o astro mais próximo da Terra.#A afirmação abaixo está certa ou errada?#A atmosfera da Lua é igual à da Terra.",20,DW*.8,16743936,16743936,16743936,16743936,image_alpha);
