...
if BTech(MA,image_index,DW/5,DH/5*3,128-48*image_alpha,"Terra",16743936)OBA_ASTRONOMIA1_CORRECT();
if BTech(MA,image_index,DW/5*2,DH/5*4,128-48*image_alpha,"Saturno",16743936)OBA_ASTRONOMIA1_WRONG();
if BTech(MA,image_index,DW/5*3,DH/5*4,128-48*image_alpha,"Lua",16743936)OBA_ASTRONOMIA1_WRONG();
