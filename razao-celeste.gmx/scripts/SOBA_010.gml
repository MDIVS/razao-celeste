...
draw_text_ext_colour(DW/2,100,"Rotação é o movimento que o planeta executa de forma elíptica em torno de sua estrela.",20,DW*.8,16743936,16743936,16743936,16743936,1);
