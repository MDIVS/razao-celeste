...
for (var i=0; i<array_length_1d(argument0); i++) {
    if (device_mouse_check_button_pressed(i,mb_left) && point_in_rectangle(device_mouse_x_to_gui(i),device_mouse_y_to_gui(i),x1,y1,x2,y2)) argument0[@i]="Bspr "+string(argument3)+","+string(argument4);
    if (argument0[i]=="Bspr "+string(argument3)+","+string(argument4)) {
        alpha2/=2;
