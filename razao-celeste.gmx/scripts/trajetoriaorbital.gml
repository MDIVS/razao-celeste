...
if (point_distance(x,y,p.x,p.y) > DH/2) {
...
if (VIEW_OBJECT == id) {
    ...
    draw_arrow(x+lengthdir_x(sprite_width/3*2,dir),y+lengthdir_y(sprite_width/3*2,dir),PLANETA.x+lengthdir_x(DH/4+sprite_width*.166,dir-180),PLANETA.y+lengthdir_y(DH/4+sprite_width*.166,dir-180),8);
